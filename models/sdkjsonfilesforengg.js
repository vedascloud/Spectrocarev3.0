var jsonfileDB = require('../app/models/sdkJsonFilesForEngg');
                ...
                jsonfileDB.findOne({filename:file.name}).exec()
                    .then((jsonfileFound) => {
                        ...
                        if(jsonfileFound){
                            ...
                            file.mv('./public/sdkjsonfilesforengg/' +filename, function (err) {
                                if (err) {
                                    console.log(err);
                                }
                                else {
                                        ...
                                        if (er) {
                                            ...
                                            jsonfileDB.updateOne({'filename': filename}, {
                                                $set: {
                                                    ...
                                                    'url': "/sdkjsonfilesforengg/" + file.name
                                                }
                                            }, (em, sm) => {
                                                if (em) {
                                                    console.log(em);
                        ...
                        //File Upload/Add
                            ...
                            let imagepath = "./public/sdkjsonfilesforengg/"+file.name;
        ...
        if(user.username==='viswa') {
            ...
            jsonfileDB.findOne({filename: user.filename}, {
                ...
                if (res) {
                    ...
                    const readStream = fs.createReadStream('./public/sdkjsonfilesforengg/' + user.filename);
