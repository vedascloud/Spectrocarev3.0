...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #EDF4F0;">
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
									...
									We received a request that you are registered as a PetClient in My Hospital.
									</p>
									<br>
									<br>
									<p style="margin: 0 10px; font-size: 20px; line-height: 30px;">
    ...
    updatePetInfo : (personalinfo,profilepic,headers,req,callback) => {
        ...
        function uploadToFolder(file,fields) {
            ...
            PetDB.find({username: new RegExp(fields.username, 'i')}).exec().then((PetData) => {

                if (PetData.clientId !== fields.clientId) {
